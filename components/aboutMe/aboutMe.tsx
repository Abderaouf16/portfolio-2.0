          ...
          <div className=" flex  ">
            <div className="flex-1 md:mr-20 ">
              <h6 className="  font-bold text-gray-600 text-2xl  lg:text-3xl ">
                ...
                <span id="e8" className="inline-block">
                  Designer
                </span>
                <span> / </span>
              ...
              <div className="font-normal text-gray-600 text-sm  lg:text-base mb-16">
                ...
                <p className="mb-2">
                  ...
                  web development and Design principles combined with{" "}
                ...
                <p className="mb-2">
                  ...
                  <span className="px-1">
                    {" "}
                    as your next designer / full stack developer ?
                  </span>
                </p>
              </div>
